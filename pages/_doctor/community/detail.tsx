...
const DoctorCommunityDetail: NextPage = () => {
  ...
  } = useQuery<GetBoardArticleResponse, GetBoardArticleVariables>(
    GET_BOARD_ARTICLE,
    {
  ...
  const [likeTargetBoardArticle, { loading: likeArticleLoading }] =
    useMutation(LIKE_TARGET_BOARD_ARTICLE);
  ...
  const coverImage =
    articleImage || (!contentHasImage ? getFallbackImage(article.articleCategory) : "");
  const authorName = article.memberData?.memberNick || "Unknown";
  const authorImage =
    toAbsoluteMediaUrl(article.memberData?.memberImage) || "/img/defaultUser.svg";
            ...
            <Stack className="author-meta">
              ...
              <Stack className="article-stats">
                ...
                <Stack className="stat-item">
                  ...
                  <Typography className="stat-count">
                    {article.articleComments || comments.length}
                  </Typography>
                </Stack>
              </Stack>
            </Stack>
                  ...
                  <Stack key={comment._id} className="comment-item">
                    ...
                    {showReplyBox[comment._id] && (
                      <Stack className="reply-box">
                        <Avatar
                          src={toAbsoluteMediaUrl(user.memberImage) || "/img/defaultUser.svg"}
